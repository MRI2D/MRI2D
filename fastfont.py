...
class Fastfont:
    ...
    def __init__(self,screen,name,size,color,bold,italic,swposx=-1,swposy=-1):
        self.swposx = swposx  # Default x = left side
        self.swposy = swposy  # Default y = top
    ...
    def printat(self, screen, x, y, text, ctr=False):
